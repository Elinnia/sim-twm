...
<!-- Custom styles for this page -->
 ...
 <!-- Page level plugins -->
    ...
    <script type="text/javascript">
        ...
        function get_data(){
            var form  = $(".form_akademik").serializeArray();
            var url = "{{ route('akademik.get_data') }}";
            $.ajax({
                type:'POST',
                data:form,
                url:url,
                    ...
                    $.each(data,function(i,item){
                        html+=`<tr>
                            <td>
                                ...
                                <input type="hidden" name="kode_akademik[]" value="${item.kode_akademik}">
                            </td>
                            <td>${item.nama_peserta_didik}</td>
                            
                            <td><input type='text' class='form-control form-control-sm keterangan' name='keterangan[]' value='${item.keterangan}' placeholder="Keterangan Akademik" ></td>
                        </tr>`;
                    });
                    $("#tb_data").html(html);
                },
