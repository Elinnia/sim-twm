...
<div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Approval Walikelas</h6>
</div>

<div class="card-body">
    <form class="form_raport">
    <input type="hidden" name="type" value="walikelas" />  
    <div class="row">
        <div class="col-sm-6">
 ...
 <!-- Page level plugins -->
    ...
    <script type="text/javascript">
        ...
        function get_data(){
            ...
            var url = "{{route('raport.get_data_walikelas')}}";
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $.each(data,function(i,item){
                        var status_raport = `<span class="badge badge-sm badge-danger">Belum Approve Walikelas</span>`;
                        
                        if(item.raport!=null){
                            status_raport = `<span class="badge badge-sm badge-success">Sudah Approve Walikelas</span>`;
                        }
                        html+=`<tr>
                            <td>
