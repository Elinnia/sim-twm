   ...
   <div class="container-fluid">
       ...
       <div class="card shadow mb-4">
           <div class="card-header py-3">
               <h6 class="m-0 font-weight-bold text-primary">Kenaikan/Kelulusan</h6>
           </div>

           <div class="card-body">
               <form class="form_kenaikan">
                    <div class="row">
                        <div class="col-sm-6">
                       ...
                       <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                           <thead>
                               <tr>
                                    ...
                                    <th align="center" bgcolor="#F0F8FF">Status</th> 
   ...
   <script type="text/javascript">
       ...
       function get_data() {
           var form = $(".form_kenaikan").serializeArray();
           var url = "{{route('kenaikan.get_data')}}";
           var kelas = $(".list-kelas").val();
           ...
           $.ajax({
               ...
               success: function(data) {
                   ...
                   $.each(data, function(i, item) {
                       var option = `<option selected value="">Pilih Status</option>`;
                       ...
                       if(kelas=="XII"){
                            ...
                            if(item.status=="tidak-lulus"){
                                selected_no = "selected";
                            }
                            
                            option += `
                                    <option value="lulus" ${selected_yes}>Lulus</option>
                                    <option value="tidak-lulus" ${selected_no}>Tidak Lulus</option>`;
                        }
                        else{
                            var selected_yes="";
                            var selected_no="";
                            ...
                            if(item.status=="tidak-naik"){
                                selected_no = "selected";
                            }
                            option += `
                                    <option value="naik" ${selected_yes}>Naik</option>
                                    <option value="tidak-naik" ${selected_no}>Tidak Naik</option>`;
                        }
                       html += `<tr>
                            <td>
                                ${item.nisn}
                                ...
                                <input type="hidden" name="kode_kenaikan[]" value="${item.kode_kenaikan_kelas}">
                            </td>
