 ...
 <div class="container-fluid">
     ...
     <div class="card shadow mb-4">
         ...
         <div class="card-body">
             <form class="form_deskripsi_karakter">
                 <div class="row">
                    <div class="col-sm-6">
 ...
 <script type="text/javascript">
     ...
     function get_data() {
         var form = $(".form_deskripsi_karakter").serializeArray();
         var url = "{{route('deskripsi_karakter.get_data')}}";
         $.ajax({
             type: 'POST',
             data: form,
             url: url,
                 ...
                 $.each(data, function(i, item) {
                     html += `<tr>
                            <td>
                                ...
                                <input type="hidden" name="kode_deskripsi[]" value="${item.kode_deskripsi}">
                            </td>
                            <td>${item.nama_peserta_didik}</td>

                            <td><input type='text'class='form-control form-control-sm integritas' name='integritas[]' value='${item.integritas}'placeholder="integritas"></td>

                            <td><input type='text'class='form-control form-control-sm religius' name='religius[]' value='${item.religius}'placeholder="religius"></td>

                            <td><input type='text'class='form-control form-control-sm nasionalis' name='nasionalis[]' value='${item.nasionalis}'placeholder="nasionalis"></td>

                            <td><input type='text'class='form-control form-control-sm mandiri' name='mandiri[]' value='${item.mandiri}'placeholder="mandiri"></td>
                            
                            <td><input type='text' class='form-control form-control-sm gotong_royong' name='gotong_royong[]' value='${item.gotong_royong}' placeholder="gotong_royong"></td>
                        </tr>`;
                 });
                 $("#tb_data").html(html);
             },
     ...
     function submit() {
         var form = $(".form_deskripsi_karakter").serializeArray();
         var url = "{{route('deskripsi_karakter.store')}}";
         $.ajax({
             type: 'POST',
             data: form,
             url: url,
             ...
             success: function(data) {
                 ...
                 Swal.fire({
                     icon: 'success',
                     title: 'Pemberitahuan',
                     text: 'deskripsi_karakter berhasil di input'
                 })
                 get_data();
             },
             error: function(data) {
