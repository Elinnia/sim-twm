...
<div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Karakter</h6>
</div>

<div class="card-body">
    <form class="form_karakter">
     <div class="row">
        <div class="col-sm-6">
...
<!-- Custom styles for this page -->
 ...
 <!-- Page level plugins -->
    ...
    <script type="text/javascript">
        ...
        function get_data(){
            var form  = $(".form_karakter").serializeArray();
            var url = "{{route('karakter.get_data')}}";
            $.ajax({
                type:'POST',
                data:form,
                url:url,
                    ...
                    $.each(data,function(i,item){
                        ...
                        html+=`<tr>
                            <td>
                                ...
                                <input type="hidden" name="kode_catatan[]" value="${item.kode_catatan}">
                            </td>
                            ...
                            <td>
                             ...
                             <td>
                             <input type="text" class="form-control" name="catatan_perkembangan_karakter[]" placeholder="Catatan perkembangan karakter" value="${item.catatan_perkembangan_karakter}" />
                            </td>
                        </tr>`;
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    Swal.fire({
                      icon: 'success',
                      title: 'Pemberitahuan',
                      text: 'Akademik berhasil di input'
                    })
                    get_data();
                },
                error:function(data){
