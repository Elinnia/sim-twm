...
<!-- Custom styles for this page -->
 ...
 <!-- Page level plugins -->
    ...
    <script type="text/javascript">
        ...
        function get_data(){
            var form  = $(".form_pkl").serializeArray();
            var url = '{{route('pkl.get_data')}}';
            $.ajax({
                type:'POST',
                data:form,
                url:url,
                    ...
                    $.each(data,function(i,item){
                        html+=`<tr>
                            <td>
                                ...
                                <input type="hidden" name="kode_pkl[]" value="${item.kode_pkl}">
                            </td>
                            <td>
                                ${item.nama_peserta_didik}
                            </td>
                            <td><input type='text' class='form-control form-control-sm mitra_dudi' name='mitra_dudi[]' value='${item.mitra_dudi}' placeholder="Mitra Dudi" ></td>
                            <td><input type='text' class='form-control form-control-sm lokasi' name='lokasi[]' value='${item.lokasi}' placeholder="Lokasi" ></td>
                            <td><input type='text' class='form-control form-control-sm masa_bulan' name='masa_bulan[]' value='${item.masa_bulan}'
                                placeholder="Masa Bulan"></td>
                            <td><input type='text' class='form-control form-control-sm keterangan' name='keterangan[]' value='${item.keterangan}'
                                placeholder="Keterangan pkl"></td>
                            </td>
                        </tr>`;
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    Swal.fire({
                      icon: 'success',
                      title: 'Pemberitahuan',
                      text: 'Data PKL berhasil di input'
                    })
                    get_data();
                },
                error:function(data){
